...
namespace BetaCycle4.Migrations
{
    ...
    [Migration("20240506105342_newFielAdded")]
    partial class newFielAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BetaCycle4.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("BetaCycle4.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.LogError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BetaCycle4.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BetaCycle4.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BetaCycle4.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("BetaCycle4.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BetaCycle4.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("BetaCycle4.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("BetaCycle4.Models.CustomerAddress", b =>
                {
                    b.HasOne("BetaCycle4.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("BetaCycle4.Models.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("BetaCycle4.Models.Product", b =>
                {
                    b.HasOne("BetaCycle4.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("BetaCycle4.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BetaCycle4.Models.ProductCategory", b =>
                {
                    b.HasOne("BetaCycle4.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("BetaCycle4.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("BetaCycle4.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("BetaCycle4.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("BetaCycle4.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("BetaCycle4.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("BetaCycle4.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("BetaCycle4.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("BetaCycle4.Models.Address", "ShipToAddress")
